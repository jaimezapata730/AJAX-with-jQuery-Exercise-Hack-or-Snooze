...
function generateStoryMarkup(story, favDeleteBtn = false) {
  ...
  return $(`
      <li id="${story.storyId}">
      ${favDeleteBtn ? getDeleteBtnHTML() : ""}
      ${favStar      ? getFavStarHTML(story, currentUser) : ""}
...
function getFavStarHTML(story, user) {
